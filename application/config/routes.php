...
$route['admin/admin_profile/:num'] = 'admin/main/profile';
$route['admin/checkUserNameIfExists'] = 'admin/main/checkUserNameIfExists';
$route['admin/checkLoginDetails'] = 'admin/main/checkLoginDetails';
$route['admin/settings']='admin/main/settings';
$route['admin/saveGeneralSettingDetails']='admin/main/saveGeneralSettingDetails';
$route['404_override'] = '';
$route['translate_uri_dashes'] = FALSE;
